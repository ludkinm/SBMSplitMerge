...
#' @param ... additional arguments to store in the sbmmod object
#' @seealso \code{\link{blockmod}} \code{\link{parammod}} \code{\link{edgemod}}
#' @return an sbmmod object with a method `r(n)` sampling an \code{sbm} object with `n` nodes from the model and a method `logd(sbm)` computing the log-density of `sbm` under the model
#' @export
